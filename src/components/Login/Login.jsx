...
<div className='text-emerald-700 text-center m-3'>
<Link  to="/register" >   <span className= 'sm:text-lg md:text-xl my-5 font-semibold'>you don't have any account? Resigter now</span></Link>
 </div>
 <div className='text-emerald-700 text-center m-3'>
<Link  to="/forgetPassword" >   <span className=' sm:text-lg md:text-xl my-5 font-semibold'>forget Password?</span></Link>
 </div>
</div>
